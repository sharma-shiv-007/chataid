...
import { ArrowLeft, CalendarDays, FileText, FlaskConical } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100" style={{ fontFamily: "system-ui, sans-serif" }}>
      ...
      <main className="mx-auto max-w-5xl p-5">
        <div className="mb-5">
          <h1 className="text-2xl font-bold text-white">Completed Lab Reports</h1>
          <p className="mt-1 text-sm text-slate-400">Open a report to review result values, ranges, and attached PDFs.</p>
        </div>
